  ...
  return (
    <section className="applications-section">
      {applications.map((app) => (
        <div key={app.id} className={`application-item ${app.position === 'right' ? 'reverse' : ''}`}>
          ...
          <div className="application-content">
            <h3 className="application-heading">{app.heading}</h3>
            <p className="application-text">{app.content}</p>
          </div>
        </div>
      ))}
    </section>
